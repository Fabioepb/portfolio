  ...
  .init({
    ...
    ,es:{
      translation: {
        ...
        "keystoneNote": "Single page application hecha con React que le permite a la compañía vender o rentar sus propiedades a residentes de Maracaibo a través de el internet",
