  ...
  .init({
    resources: {
      ...
      translation: {
        ...
        "description2": "I consider myself a focused guy, with a strange curiosity for the unknown that motivates me to learn and improve every day.",
        "description3": "Outside of programming, I love listening to podcasts and audiobooks, coffee, video games and I would love to learn how to paint.",
    ...
    ,es:{
      translation: {
        "salute":"Hola.",
        "name": "Mi nombre es ",
        "description1": "Soy Ing. de Computación y desarrollador de software, mi área de enfoque es el desarrollo Web y Móvil. La mayoría de mis proyectos se encuentran alojados en mi",
        ...
        "description3": "Además de mi carrera como desarrollador, me encantan los podcasts, el café y algún día me gustaría aprender a pintar.",
        "onlyName": "Fabio Pineda",
        ...
        "note2": "Con 2 años de experiencia como desarrollador de software, he obtenido conocimientos y aprendido tecnologías que me permiten entregar productos de calidad a mis clientes consistentemente.",
        "projectsNote":"En mi tiempo como desarrollador, he tenido la oportunidad de trabajar en múltiples proyectos que me enseñaron mucho sobre principios de diseño, mejores prácticas y programación en general",
        "keystoneNote": "Single page application hecha con React que le permite a la compañía vender o rentar sus propiedades a residentes de Maracaibo a través del internet",
        "luxNote": "Solución de minado en la nube que te permite rentar equipos para minar tus criptomonedas favoritas",
