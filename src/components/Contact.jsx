    ...
    if (event.target.value.length > maxCharacters[event.target.name]) {
      setValues({
        ...
        [event.target.name]: event.target.value.slice(
          0,
          maxCharacters[event.target.name]
        ),
      });
      return;
    }
        ...
        <Grid container direction="column" justify="center" alignItems="center">
          ...
          <Grid className={classes.inputGrid}>
            <TextField
              ...
              className={cx(
                classes.input,
                error.includes("name") && classes.errorHighlight
              )}
          ...
          <Grid className={classes.inputGrid} id="contact">
            <TextField
              ...
              className={cx(
                classes.input,
                error.includes("email") && classes.errorHighlight
              )}
            />
          </Grid>
          <Grid className={classes.inputGrid}>
            <TextField
              ...
              className={cx(
                classes.input,
                error.includes("message") && classes.errorHighlight
              )}
              onChange={handleChange}
            />
          </Grid>
          <Grid>
            <Button
              disabled={isDisabled}
              title={
                isDisabled ? "Please wait to send another email" : "Send email"
              }
              variant="outlined"
